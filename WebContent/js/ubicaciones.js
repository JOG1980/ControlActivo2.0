    	...
    	$.ajax({
    	    ...
    	    success: function (data, status, xhr) {
    	    	...
    	    	if(obj.estado_proceso == "ERROR"){
          			...
          			showErrorMessages(obj.error_codes, obj.error_msg, my_error_msg);
          		}
    	    },
    	    error: function (jqXhr, textStatus, errorMessage) {
    	            //$("#my_id1").append('Error' + errorMessage);
...
//boton borrar -----------------------------------------
	...
	var showErrorMessages = function(error_code, error_msg_raw, error_msg_interpretado){
			...
			var full_error_msg = "code: " + error_code +"\r\n"+ error_msg_raw;
